...
> ## 🧪 RECETTE À FAIRE — US NUTR-17 Régularité du journal (Stats nutrition mobile, Florian, 16/07/2026)
>
...
> ## 🧪 RECETTE À FAIRE — US NUTR-10 Adhérence à l'objectif (Stats nutrition mobile, Florian, 16/07/2026)
>
...
- [~] **US NUTR-17 — Régularité du journal (taux de complétion)** — **code livré & mergé sur `dev`**
  ...
  **Spec + plan validés Florian (16/07/2026).** Carte « Régularité du journal » sur Stats nutrition
  ...
  tests(702) verts. Catalogue NUTR-17 → ✅. **Reste : recette device + relecture Damien.** Spec :
...
- [~] **US NUTR-10 — Adhérence à l'objectif calorique** — **code livré & mergé sur `dev`**
  ...
  **Reste : recette device + relecture Damien.** Spec :
