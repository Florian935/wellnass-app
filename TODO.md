...
*Dernière mise à jour : 12/07/2026 (Nutrition : 4.34 détail d'entrée + 4.35 suivi micros — livrés & **validés device**, + fix double encodage JSON PowerSync sur `parseMicronutrients` · Running R3b-ii bibliothèque programmes course reste checkpoint 🔴)*
