...
- [~] **US RN-01/RN-02 — Dépense course → objectif du jour** (`feature/rn01-depense-course-objectif`,
  ...
  **Forfait/Auto** : en Auto l'objectif du jour suit la **dépense estimée des courses terminées**
  ...
  subagent-driven). **Checkpoint 🔴 Florian** : migration `training_bonus_mode` (`db:push` + `db:types`),
  non bloquante (défaut `'fixed'`). _Exécution en cours._
