...
- [ ] **Modifier / supprimer un aliment ajouté à un repas — geste peu découvrable + édition limitée à la
  quantité** — _remontée Florian, 16/07/2026, à reproduire sur device._ Constat utilisateur : « on ne
...
- [~] **US MN-06 — Apport protéique par kg (vs cible par objectif)** (`feature/mn06-proteines-par-kg`,
  ...
  typecheck/lint/tests(676) verts. **🔴 Reste recette device (Florian)** : g/kg cohérent, statut selon
  objectif, bascule 7 j/30 j, empty states (pas de pesée / pas de repas) — via dataset de recette. + relecture Damien.
