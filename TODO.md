...
- [x] **US META-09 — Lissage des courbes par moyenne mobile** — **CODE LIVRÉ** (subagent-driven,
  ...
  **4 courbes** (poids, kcal, allure, muscu). Fenêtre **en points** (pas en jours), taille fixe auto ;
  ...
  pas de glitch d'axe allure) + relecture Damien.** Spec :
