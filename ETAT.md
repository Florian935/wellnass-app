...
**MVP1 (= V1.0 complète)** `██████████████████░░` **89 %** — 195 livré · 17 partiel · 2 à faire (sur 220)
...
| | |
|---|---|
| Branche courante | `feature/insights02-degonflage-tier0` (modifications non commitées) |
| Commits | 1086 · `main` a **1083** commits de retard sur `dev` |
| Specs d'US | 126 au total — 79 clôturées, 47 en cours |
