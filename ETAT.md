...
| **MUSCU-FIX02** — La séance en direct doit dérouler — lenteurs, écrans noirs, bascule de mode, clôture | `recette` | `dev` | [3.59, 3.61] |
...
| Commits | 1324 · `main` a **1321** commits de retard sur `dev` |
