...
**MVP1 (= V1.0 complète)** `███████████████████░` **95 %** — 249 livré · 4 partiel · 3 à faire (sur 262)
...
| Commits | 1312 · `main` a **1309** commits de retard sur `dev` |
