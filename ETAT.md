...
**MVP1 (= V1.0 complète)** `████████████████░░░░` **81 %** — 168 livré · 12 partiel · 23 à faire (sur 208)
...
<details><summary>P1 finitions (12) · P2 confort (5)</summary>
...
| | |
|---|---|
| Branche courante | `feature/mesur01-mensurations` (modifications non commitées) |
| Commits | 953 · `main` a **950** commits de retard sur `dev` |
| Specs d'US | 80 au total — 75 clôturées, 5 en cours |
