...
**MVP1 (= V1.0 complète)** `███████████████████░` **95 %** — 231 livré · 4 partiel · 2 à faire (sur 243)
...
| | |
|---|---|
| Branche courante | `feature/guid01-objectif-regime-guidage` (modifications non commitées) |
| Commits | 1233 · `main` a **1232** commits de retard sur `dev` |
| Specs d'US | 149 au total — 85 clôturées, 64 en cours |
| Migrations | 95/97 poussées sur le cloud |
