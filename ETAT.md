...
| **CORPS-01** — Carte anatomique et explorateur Mon corps | `recette` | `feature/corps01-explorateur` | [6.2] |
| **CORPS-02** — Silhouette personnelle et intention visuelle | `recette` | `feature/corps02-morphologie` | [6.5] |
...
| Commits | 1217 · `main` a **1212** commits de retard sur `dev` |
