...
**MVP1 (= V1.0 complète)** `████████████████░░░░` **81 %** — 168 livré · 11 partiel · 24 à faire (sur 208)
...
| | |
|---|---|
| Branche courante | `feature/uxlot01-finitions-recette` (modifications non commitées) |
| Commits | 952 · `main` a **949** commits de retard sur `dev` |
| Specs d'US | 79 au total — 75 clôturées, 4 en cours |
