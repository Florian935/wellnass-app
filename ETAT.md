...
**MVP1 (= V1.0 complète)** `█████████████████░░░` **83 %** — 172 livré · 20 partiel · 10 à faire (sur 208)
...
| | |
|---|---|
| Branche courante | `feature/muscf8-notifications-muscu` (modifications non commitées) |
| Commits | 972 · `main` a **969** commits de retard sur `dev` |
