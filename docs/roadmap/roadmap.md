...
> **240 → 241 le 13/09/2026** : création de la ligne **3.61** (MUSCU-UX03, mode immersif de la séance)
> dans « Hors périmètre de cadrage ». Née d'une demande de Florian (12/09) d'une séance plus immersive,
> puis d'une décision du 13/09 : **c'est un mode en plus, le classique reste**. Spec, plan et maquettes
> déposés, **en attente de validation** — d'où ⬜ et non 🟡 : aucune ligne de code applicatif écrite.
> Hors cadrage passe de 24 à 25 lignes.
>
> **⬜ → ✅ le 13/09/2026 (bis)** : la ligne **3.61** passe à ✅ — les dix lots du plan sont
> écrits (mode et réglages, briques pures dans `packages/shared`, écran immersif, effort,
> cadran, repos vivant, retours, cérémonie de fin, coach vocal, brief et fil). Le mode
> **classique reste inchangé** : il ne gagne que la pastille de record au repos (décision D3).
> 56 critères de recette en [RECETTES.md §62](../../RECETTES.md). Livré ≠ validé : la recette
> device reste à faire.
>
