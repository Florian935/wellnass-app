...
| **Total périmètre de lancement** | **248** | |
...
| Hors cadrage (25) | 24 | 0 | 1 | 0 | 0 | **100 % livré.** ⚠️ **24 lignes et non 20** : le total n'avait pas suivi les 4 lignes créées depuis le 05/08 (7.20, 7.21, 1.28, 1.29). Refonte muscu, widgets multi-formes, micronutriments, refonte nutrition, écran « Insights » + dégonflage du Tier 0, mode « vie réelle », journal des zones douloureuses. |
