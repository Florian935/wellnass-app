...
**Avancement réel du code — périmètre de lancement (V0.1 → V1.1, réconcilié le 03/08/2026)** :
...
| **Total périmètre de lancement** | **223** | |
...
| Hors cadrage (20) | 20 | 0 | 0 | 0 | 0 | **100 % livré** — refonte muscu, widgets multi-formes, micronutriments, refonte nutrition, **7.20 écran « Insights »** et **7.21 dégonflage du Tier 0** (INSIGHTS-01 et 02, 05/08/2026, en recette). |
