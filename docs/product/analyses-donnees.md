...
| MUSC-04 | ⏳ | Courbe de progression charge & volume par exercice | Courbe temporelle charge max / volume / 1RM par exercice, sélecteur de période. | `workout_sets` agrégés, `personal_records` | courbe | 30/90 j/1 an/tout | Tendance long terme d'un mouvement, valider la surcharge. | 3.21 / 3.39 / 6.2 |
...
| MN-02 | ✅ | Alerte déficit calorique + fort volume muscu | Apports moyens ≥15 % sous l'objectif ET volume muscu hebdo élevé. | `shouldAlertDeficitVolume()` (bodyweight.ts), `food_entries`, `workout_sets` | alerte | semaine glissante | Prévenir la fonte musculaire/contre-perf due au sous-apport. | 4.32 |
