...
Seul **commit** est partagé à ce jour. `/us`, `/etat` et `/reconcilier` restent des commandes
propres à Claude (`.claude/commands/`) ; pour les rendre accessibles à Codex, suivre la procédure
ci-dessous.
