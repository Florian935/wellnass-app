  ...
  return (
    <ThemeProvider value={theme}>
      ...
      <Stack screenOptions={{ headerShown: false }}>
        ...
        {/* Aperçu de la séance du jour (US MUSCU-UX07, §4.5) : il porte son propre en-tête. */}
        <Stack.Screen name="session-preview" options={{ headerShown: false }} />
        ...
        {/* ⚠️ SPIKE TECHNIQUE — à retirer avec l'écran (docs/specs/technical/spike-3d-corps.md). */}
        <Stack.Screen name="spike-corps-3d" options={{ headerShown: false }} />
