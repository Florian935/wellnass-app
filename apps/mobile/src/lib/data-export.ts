...
export const EXPORT_TABLES: { table: string; col: 'user_id' | 'owner_id' }[] = [
  ...
  // US NUTRI-UX01 (R5) — hydratation. Donnée personnelle quotidienne : sans elle, l'export
  // RGPD serait incomplet dès la première journée où l'utilisateur boit.
  { table: 'water_entries', col: 'user_id' },
