...
export const fr = {
  ...
  exercises: {
    ...
    fineMusclesLabel: 'Muscles fins (optionnel)',
    fineMusclesHint:
      'Précise le schéma corporel de la fiche mobile. Tant qu\'aucun muscle fin n\'est coché, la fiche retombe sur le groupe musculaire large ci-dessus.',
    fineMuscleRegions: {
  ...
  programs: {
    ...
    targetRpe: 'RPE cible (1-10)',
    targetTime: 'Objectif chrono',
    instructions: 'Consigne',
    instructionsPlaceholder: 'Ex. Ne pas accélérer le premier 1 000 m',
    adaptationCriterion: "Critère d'adaptation",
    adaptationCriterionPlaceholder: 'Ex. Réduire à 4 répétitions si la foulée se dégrade',
    ...
    intervalsTitle: 'Blocs fractionné',
    addInterval: 'Ajouter un bloc',
    removeInterval: 'Retirer le bloc',
    removeIntervalConfirm: 'Retirer ce bloc de la séance ?',
    noIntervals: 'Aucun bloc pour le moment.',
    intervalReps: 'Répétitions',
    intervalFastKind: 'Phase rapide',
    intervalFastDistanceM: 'Distance (m)',
    intervalFastDurationS: 'Durée (s)',
    intervalPctVma: '% VMA (facultatif)',
    intervalRecoveryKind: 'Récupération',
    intervalRecoveryNone: 'Aucune',
    intervalRecoveryDistanceM: 'Distance (m)',
    intervalRecoveryDurationS: 'Durée (s)',
    intervalKindDistance: 'Distance',
    intervalKindDuration: 'Durée',
