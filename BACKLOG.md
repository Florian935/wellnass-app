...
| ~~**ACTIV-01 — Parcours « 7 jours pour démarrer »**~~ | roadmap 1.27 | — | 🟡 **Entrée en pipeline le 03/08/2026** → [spec](docs/specs/functional/us/activ01-parcours-7-jours.md). La **seule** feature de rétention qui fonctionne le jour du lancement : contrairement au bilan hebdo, aux souvenirs ou au wrapped, elle n'exige **aucun historique**. Surtout du **contenu FR+EN** + un widget dashboard. À ne pas confondre avec l'onboarding (1.7-1.9) : activation, pas inscription. |
