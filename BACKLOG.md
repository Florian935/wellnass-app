...
| **TEINTE-01 — Le bordeaux perd sa couleur en thème clair** *(constat NUTRI-UX02)* | — | La surface teintée de la **Musculation** en thème clair sort à **chroma 9**, soit *sous* la surface neutre (13) : teinter lui enlève de la couleur au lieu de lui en donner. La Course est juste au-dessus (15). C'est le même défaut que ceux corrigés sur la Course (CARDIO-UX02) et la Nutrition (NUTRI-UX02), sur un troisième pilier. | 🟢 **Trouvé par le test-garde neuf** de NUTRI-UX02, dès sa première exécution — il vivait jusque-là sans que rien ne le signale, parce que `tintPreservingLuminance` conserve la luminance et fait donc passer tous les tests de contraste. ⚠️ **Non corrigé avec NUTRI-UX02, délibérément** : le lot validé portait sur la nutrition, et retoucher le bordeaux reviendrait à défaire l'arbitrage du 19/09 (« le bordeaux adouci »). Le test porte une **exception nommée et datée** (plancher à 9) : la situation est visible et ne peut plus empirer en silence. 🟠 La cause est mécanique et connue : en thème clair, `tintPreservingLuminance` finit le chemin **vers le blanc** (sa phase 2), et une teinte sombre comme `#7c2734` est massivement blanchie. Le remède est le même qu'ici : une teinte source plus claire pour le clair, ou un gain propre au thème. |
