    ...
    Tables: {
      ...
      exercise_plans: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "exercise_plans_owner_id_fkey"
            columns: ["owner_id"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
      ...
      exercise_translations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "exercise_translations_owner_id_fkey"
            columns: ["owner_id"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
      ...
      food_translations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "food_translations_owner_id_fkey"
            columns: ["owner_id"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
      ...
      meal_template_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "meal_template_items_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
      ...
      planned_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "planned_sessions_owner_id_fkey"
            columns: ["owner_id"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
      ...
      program_translations: {
        ...
        Relationships: [
          {
            foreignKeyName: "program_translations_owner_id_fkey"
            columns: ["owner_id"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
      ...
      running_pace_records: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "running_pace_records_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
      ...
      running_profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "running_profiles_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
      ...
      streak_jokers: {
        ...
        Relationships: [
          {
            foreignKeyName: "streak_jokers_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
