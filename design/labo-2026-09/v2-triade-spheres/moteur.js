...
(function () {
  ...
  var ELEMENTS = [
    { id: 'fq', sym: 'Fq', name: 'Séances', pillar: 'muscu', color: '#e07a98', values: [0, 2, 3, 4, 5], def: 2, fmt: function (v) { return v === 0 ? 'absent' : v + ' séances/sem'; } },
    { id: 'km', sym: 'Km', name: 'Kilomètres', pillar: 'course', color: '#6fa8ef', values: [0, 15, 25, 35], def: 2, fmt: function (v) { return v === 0 ? 'absent' : v + ' km/sem'; } },
    ...
    { id: 'so', sym: 'So', name: 'Nuit', pillar: 'socle', color: '#e0b155', values: [6.5, 7.5, 8.5], def: 1, fmt: function (v) { return String(v).replace('.5', ' h 30').replace(/^(\d)$/, '$1 h'); } },
  ];
